...
<body>
    ...
    <div id="content">
        <h3 style="text-decoration: underline; padding: 0 0; text-align: center;">REPORTE DE ACTIVOS</h3>
        <table>
            <thead>
                <tr>
                    <th scope="col">Nro</th>
            ...
            <tbody>
                @foreach ($assets as $asset)
                    <tr>
                        ...
                        <td scope="row">{{ $asset->code }}</td>
                        <td scope="row">{{ $asset->name }}</td>
                        <td scope="row">{{ $asset->state->name }}</td>
                        <td scope="row">{{ $asset->category->name }}</td>
                        <td scope="row">{{ $asset->location->name }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
