...
@section('content_header')
    <div class="row justify-content-center">
        <div class="col-md-10">
            <h4><b>DEVOLUCIÓN DE HERRAMIENTAS</b></h4>
        </div>
    </div>
@stop
            ...
            <form action="{{ route('loans.update', $loan) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card col-12">
                    <div class="card-header">
                        <h5><b>Datos de la herramienta a devolver</b></h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group form-group">
                                            ...
                                            <input name="date_time_return" type="datetime-local" class="form-control" required>
                                        </div>
                    ...
                    <div class="col-md-12 mb-5">
                        <div class="btn-group pull-right me-2">
                            <button type="submit" class="btn btn-sm btn-primary" title="Guardar">
                                <i class="fa-solid fa-save mr-2"></i><span class="hidden-xs">Devolver préstamo</span>
                            </button>
                        </div>
                        <div class="btn-group pull-right me-2">
                            <a href="{{ route('loans.return') }}" class="btn btn-sm btn-secondary" title="Cancelar">
