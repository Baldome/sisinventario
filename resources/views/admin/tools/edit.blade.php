                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <select name="state" class="form-control" required>
                                                <option value="Bueno" {{ $tool->state === 'Bueno' ? 'selected' : '' }}>
                                                    Bueno
                                                </option>
                                                <option value="Regular" {{ $tool->state === 'Regular' ? 'selected' : '' }}>
                                                    Regular</option>
                                                <option value="Malo" {{ $tool->state === 'Malo' ? 'selected' : '' }}>Malo
                                                </option>
                                                <option value="Inoperativo"
                                                    {{ $tool->state === 'Inoperativo' ? 'selected' : '' }}>Inoperativo
                                                </option>
                                                <option value="Obsoleto"
                                                    {{ $tool->state === 'Obsoleto' ? 'selected' : '' }}>Obsoleto</option>
                                            </select>
                                        </div>
                                        @error('state')
                                            <small style="color: red">{{ $message }}</small>
